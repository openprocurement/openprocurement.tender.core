...
from openprocurement.tender.core.tests.base import TenderContentWebTest
...
class TenderDocumentResourceTest(TenderContentWebTest):
    ...
    def test_not_found(self):
        ...
        response = self.app.get('/tenders/{}/documents/some_id?acc_token={}'.format(
...
class TenderDocumentWithDSResourceTest(TenderDocumentResourceTest):
    ...
    def __test_create_tender_document_error(self):
        self.tearDownDS()
